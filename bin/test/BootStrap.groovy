        ...
        (1..5).each { index ->
            ...
            (1..3).each {
                if(index == 1){
                    ...
                    annonceInstance.addToIllustrations(new Illustration(filename: "https://i.redd.it/dm49b254pw171.png"))
                }else{
                    annonceInstance.addToIllustrations(new Illustration(filename: "https://everipedia-storage.s3.amazonaws.com/GalleryMediaItem/lang_en/bored-ape-yatch-club/09763558-FCB0-4984-B677-E2285960DD9Bjpeg.jpeg"))
                }
            }
